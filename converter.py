...
def convert():
    ...
    confirm = tk.Label(master=frame, text="Your file has been converted and saved go check it out!", fg="blue")
    confirm.pack()
...
title.pack()
title2 = tk.Label(master=frame, text="Type in the location(file path) of the file below", fg="blue")
title2.pack()
fileloc = tk.Entry(master=frame, fg="black", width=50)
fileloc.pack()
title3 = tk.Label(master=frame, text="Type in where(file path) you want the converted file saved below", fg="blue")
title3.pack()
